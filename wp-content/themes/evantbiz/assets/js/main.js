...
(function($) {
    ...
    if ($(".text-anim").length) {
        ...
        if ($('[data-date]').length > 0) {
            targetDate = new Date($('[data-date]').data('date')).getTime();
        } else if ($('.coming-soon-time').length > 0) {
            targetDate = new Date($('.coming-soon-time').data('event-time')).getTime();
        } else {
            targetDate = new Date("2026-12-01 00:00:00").getTime();
        }
